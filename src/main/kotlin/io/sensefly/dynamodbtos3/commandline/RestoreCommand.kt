...
class RestoreCommand {
  ...
  @Parameter(names = arrayOf("-s", "--source"), description = "Full S3 path to a JSON backup file (s3://my-bucket/folder/my-table.json).", required = true, order = 1)
  lateinit var source: URL
